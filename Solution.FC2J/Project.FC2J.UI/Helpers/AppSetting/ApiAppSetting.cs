...
namespace Project.FC2J.UI.Helpers.AppSetting
{
    public class ApiAppSetting : IApiAppSetting
    {
        ...
        private readonly string _reportTIN;
        ...
        public ApiAppSetting()
        {
            ...
            _purchase = ConfigurationManager.AppSettings["purchase"];
            ...
            _report = ConfigurationManager.AppSettings["report"];
            _reportTIN = ConfigurationManager.AppSettings["ReportTIN"];
        }
        ...
        public decimal PoTaxRate
        {
            get
            {
                string rateText = ConfigurationManager.AppSettings["poTaxRate"];
        ...
        public string Purchase => _purchase;
        ...
        public string ReportTIN => _reportTIN;
    }
}
